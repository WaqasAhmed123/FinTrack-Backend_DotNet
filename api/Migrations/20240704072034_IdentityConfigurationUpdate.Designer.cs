...
namespace api.Migrations
{
    ...
    [Migration("20240704072034_IdentityConfigurationUpdate")]
    partial class IdentityConfigurationUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "119e2585-5410-4135-bad6-0343083b54c4",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "ad65f882-08bb-490c-8e2e-4d36a9249062",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("api.Model.Statement", b =>
                {
                    b.HasOne("api.Model.User", "User")
                        .WithOne("Statement")
                        .HasForeignKey("api.Model.Statement", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
